...
if (strlen($password) < 6) {
    ...
    redirect(BASE_URL . '/driver/reset_password.php?token=' . rawurlencode($token));
}
...
repo_update_driver_password($userId, $password);
pw_reset_clear('driver');
