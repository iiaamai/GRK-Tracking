...
-- EIR uploads (one per booking)
CREATE TABLE `eir` (
  `booking_id` INT UNSIGNED NOT NULL,
  `eir_file` VARCHAR(512) NOT NULL,
  `uploaded_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`booking_id`),
  CONSTRAINT `fk_eir_booking` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`id`)
...
INSERT INTO `bookings` (
  ...
  (
    'EXP-2026-0001', 1, 1, 'acme_corp', 'Acme Trading', 'orders@acme.test', '+63 917 000 0001',
  ...
  (
    'EXP-2026-0002', 2, 2, 'metro_retail', 'Metro Retail', 'logistics@metro.test', '+63 918 000 0002',
    '2026-03-27 14:00:00', '2026-03-27', 'L300',
    'Parañaque Hub', 'BGC',
    'Retail cartons — 200 boxes', '',
    'pending', NULL, NULL, FALSE, NULL, NULL,
    'uploads/bookings/demo-gatepass.png'
  );
