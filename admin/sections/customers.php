...
<div class="card">
  <h2>Add customer</h2>
  <form class="js-validate" method="post" action="../handlers/admin_customer_action.php" novalidate>
    <?= csrf_field() ?>
        ...
        <tbody>
          <?php foreach ($rows as $r): ?>
            <tr>
              ...
              <td><?= e($r['username'] ?? '') ?></td>
              <td>
                <form method="post" action="../handlers/admin_customer_action.php" style="display:flex;flex-wrap:wrap;gap:0.5rem;align-items:flex-end;margin:0">
                  <?= csrf_field() ?>
              ...
              <td>
                <form method="post" action="../handlers/admin_customer_action.php" style="margin:0" onsubmit="return confirm('Remove this customer from the list?');">
                  <?= csrf_field() ?>
