...
<head>
  ...
  <title>Forgot password — Customer | GRK Trucking Services</title>
...
<body>
  <div class="login-page">
    <div class="login-card">
      ...
      <?php endif; ?>
      <form class="js-validate" method="post" action="../handlers/forgot_password_customer.php" novalidate>
        <?= csrf_field() ?>
        <div class="form-row">
          <label for="identifier">Username or email</label>
          <input id="identifier" name="identifier" required autocomplete="username" maxlength="255" placeholder="acme_corp or orders@acme.test">
        </div>
        <div class="actions">
